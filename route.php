...
Route::rule('product/category', 'product/category/cate');                 //企业--分类222
Route::get('product/category_tree', 'product/category/getCateTree');                 //云产品库指定分类树形结构222
Route::rule('product/title', 'product/index/search_title');                 //企业--产品关键词搜索222
